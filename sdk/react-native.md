...
Embed the JustGold gold & silver trading UI in your React Native app with **`@justgold/rn-sdk`** (^1.1.14).
...
# or
npm install @justgold/rn-sdk@^1.1.14 react-native-webview react-native-safe-area-context
```
