...
Embed the JustGold gold & silver trading UI in your React Native app with **`@justgold/rn-sdk`** (^1.1.16).
...
# or
npm install @justgold/rn-sdk@^1.1.16 react-native-webview react-native-safe-area-context
```
