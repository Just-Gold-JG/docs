...
| --- | --- | --- | --- |
| React Native | `@justgold/rn-sdk` | ^1.1.18 | [npm](https://www.npmjs.com/package/@justgold/rn-sdk) |
| Flutter | `justgold_sdk` | ^1.1.22 | [pub.dev](https://pub.dev/packages/justgold_sdk) |
...
```bash
yarn add @justgold/rn-sdk@^1.1.18 react-native-webview react-native-safe-area-context
cd ios && pod install
```
...
## What's included in SDK 1.1.18 / 1.1.22
