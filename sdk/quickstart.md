...
| --- | --- | --- | --- |
| React Native | `@justgold/rn-sdk` | ^1.1.17 | [npm](https://www.npmjs.com/package/@justgold/rn-sdk) |
| Flutter | `justgold_sdk` | ^1.1.21 | [pub.dev](https://pub.dev/packages/justgold_sdk) |
...
```bash
yarn add @justgold/rn-sdk@^1.1.17 react-native-webview react-native-safe-area-context
cd ios && pod install
```
...
## What's included in SDK 1.1.17 / 1.1.21
