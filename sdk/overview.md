...
## SDK packages (current: RN 1.1.18 / Flutter 1.1.22)

| Platform | Package | Registry | UI hosting |
| --- | --- | --- | --- |
| React Native | `@justgold/rn-sdk` ^1.1.18 | [npm](https://www.npmjs.com/package/@justgold/rn-sdk) | JustGold CDN (signed URL via Partner API) |
| Flutter | `justgold_sdk` ^1.1.22 | [pub.dev](https://pub.dev/packages/justgold_sdk) | JustGold CDN (signed URL via Partner API) |
...
## What's included in the embedded UI (1.1.18 / 1.1.22)

| Feature | Description |
| --- | --- |
| Investment home | Live buy/sell prices, digital vault balance, **Invested / Growth / Sell Value** metrics |
| Buy / sell / delivery | Full quote → confirm → payment handoff (amount kept if the user goes Back from confirm; delivery hidden when org flag is off) |
...
3. **Install the client package** — `@justgold/rn-sdk` ^1.1.18 or `justgold_sdk` ^1.1.22.
