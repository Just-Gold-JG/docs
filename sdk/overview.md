...
## SDK packages (current: 1.1.4)

| Platform | Package | Registry | UI hosting |
| --- | --- | --- | --- |
| React Native | `@justgold/rn-sdk` ^1.1.4 | [npm](https://www.npmjs.com/package/@justgold/rn-sdk) | JustGold CDN (signed URL via Partner API) |
| Flutter | `justgold_sdk` ^1.1.4 | [pub.dev](https://pub.dev/packages/justgold_sdk) | JustGold CDN (signed URL via Partner API) |
...
## What's included in the embedded UI (1.1.4)
...
3. **Install the client package** — `@justgold/rn-sdk` ^1.1.4 or `justgold_sdk` ^1.1.4.
